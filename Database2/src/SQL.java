...
public class SQL {
    ...
    public static void addDrone(BufferedReader reader) throws IOException {
        ...
        String droneAdditionSql = "INSERT INTO Drones VALUES(" + id + ","
                + speed + "," + date + "," + manufacturer + "," + model + ","
                + capacity + "," + location + "," + range + "," + name + ","
                + year + "," + status + "," + address + ");";
    ...
    public static void updateDrone(BufferedReader reader) throws IOException {
        ...
        String droneAdditionSql = "UPDATE Drones SET Max_speed = " + speed
                + ", Warranty_exp = " + date + ", Manufacturer = "
                + manufacturer + ", Model = " + model + ", Weight_capacity = "
                + capacity + ",Location =" + location + ", Range= " + range
                + ",Name =" + name + ",Year =" + year + ",Status = " + status
                + ", Address = " + address + " WHERE Serial_no =" + id + ";";
    ...
    public static void deleteDrone(BufferedReader reader) throws IOException {
        ...
        String id = database.getUserInput(reader);
        String sql = "DELETE FROM Drones WHERE Serial_no =" + id + ";";
